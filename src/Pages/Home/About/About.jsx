        ...
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className='lg:w-1/2 p-4'>
                    <h3 className='text-2xl text-orange-600 font-bold pb-2'>About Us</h3>
                    <h1 className="text-5xl font-bold md:pr-48">We are qualified & of experience in this field</h1>
